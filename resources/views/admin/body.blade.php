<div class="main-panel">
    ...
    <footer class="footer">
      <div style="text-align: center;" class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©<a href="https://www.youtube.com/@wincoder9" target="_blank"> WIN CODER </a>2023</span>
